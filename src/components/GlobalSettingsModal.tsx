...
export const GlobalSettingsModal: React.FC<GlobalSettingsModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<"ai" | "appearance" | "legal">(
    "ai",
  );
  ...
  useEffect(() => {
    if (isOpen) {
      const loaded: GlobalSettings = {
        ...
        geminiModel:
          localStorage.getItem("neurogen-gemini-model") || "gemini-2.5-flash",
        openRouterModel:
          localStorage.getItem("neurogen-openrouter-model") ||
          "google/gemini-2.0-flash-001",
        routerAiModel:
          localStorage.getItem("neurogen-routerai-model") || "openai/gpt-4o",
        activeProvider:
          (localStorage.getItem("neurogen-active-provider") as any) || "gemini",
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <ProviderCard
                    ...
                    onClick={() =>
                      setSettings({ ...settings, activeProvider: "gemini" })
                    }
                  />
                  <ProviderCard
                    icon="🌐"
                    ...
                    onClick={() =>
                      setSettings({ ...settings, activeProvider: "openrouter" })
                    }
                  />
                  <ProviderCard
                    icon="🔄"
                    ...
                    onClick={() =>
                      setSettings({ ...settings, activeProvider: "routerai" })
                    }
                  />
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-5 bg-slate-50 dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">
                      Переключить светлый/тёмный режим
                    </p>
                  </div>
                </div>
                <button
...
const PrivacyPolicyContent: React.FC = () => (
  <div className="space-y-4 text-sm">
    ...
    <p>
      Мы собираем информацию, которую вы предоставляете при использовании
      NeuroGen Studio, включая API ключи, которые хранятся локально в вашем
      браузере.
    </p>

    <h4 className="font-bold text-lg mt-4">2. Использование информации</h4>
    <p>
      Собранные данные используются исключительно для функционирования
      приложения: генерация контента через AI провайдеров, сохранение истории
      проектов локально, аутентификация пользователя.
    </p>

    <h4 className="font-bold text-lg mt-4">3. Хранение данных</h4>
    <p>
      Все данные хранятся локально в браузере пользователя (localStorage). Мы не
      передаём и не храним ваши данные на внешних серверах, за исключением
      запросов к AI провайдерам.
    </p>

    <h4 className="font-bold text-lg mt-4">4. Безопасность</h4>
    <p>
      Мы принимаем разумные меры для защиты вашей информации, но помните, что ни
      один метод передачи данных через интернет не является полностью
      безопасным.
    </p>

    <h4 className="font-bold text-lg mt-4">5. Права пользователя</h4>
    <p>
      Вы имеете право: доступа к вашим данным, исправления неточных данных,
      удаления ваших данных, экспорта ваших данных.
    </p>
...
const TermsOfUseContent: React.FC = () => (
  <div className="space-y-4 text-sm">
    ...
    <p>
      Используя NeuroGen Studio, вы соглашаетесь с настоящими Условиями
      использования. Если вы не согласны, пожалуйста, не используйте приложение.
    </p>

    <h4 className="font-bold text-lg mt-4">2. Описание сервиса</h4>
    <p>
      NeuroGen Studio предоставляет инструменты для создания, редизайна и деплоя
      веб-сайтов с использованием искусственного интеллекта.
    </p>

    <h4 className="font-bold text-lg mt-4">3. Правила использования</h4>
    <p>
      Вы соглашаетесь не использовать сервис для: генерации незаконного или
      вредоносного контента, нарушения прав интеллектуальной собственности,
      спама или мошенничества, обхода ограничений сервиса.
    </p>
    ...
    <p>
      Все права на приложение принадлежат NeuroGen. Контент, созданный
      пользователями, принадлежит самим пользователям.
    </p>
